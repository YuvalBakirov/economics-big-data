...
* Note: Later on, we will remove one of the dummy variables to avoid multicollinearity, which can lead to issues when running linear models. However, for now, we will keep all the dummy variables as part of our exploratory data analysis (EDA) to fully explore the data.
