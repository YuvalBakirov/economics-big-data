...
train_filtered_2000m_data <- create_time_intervals(train_filtered_2000m_data, pickup_counts_1000m)
...
```{r}
# Create the time_interval and count the number of pickups per interval for 1000m data
pickup_counts_1000m1 <- train_filtered_1000m_data %>%
  mutate(time_interval = floor_date(timestamp, "15 minutes")) %>%
  group_by(time_interval) %>%
  summarise(count_pickups_per_interval = n())

pickup_counts_1000m1
```
