...
נבדוק אם עליית המחירים תואמת את שיעורי התפוסה. שיעורי תפוסה גבוהים עשויים להצביע על ביקוש גבוה יותר, מה שעלול להעלות את המחירים
...
ggplot(average_price_difference_per_day, aes(x = date, y = avg_price_difference)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
באופן כללי זה נראה שהמארחים לא דרשו פחות כסף ממה שהציגו לראשונה באתר כי כל התוצאות שליליות מה שאומר שהמחירים בפועל היו תמיד גבוהים מהמחיר הראשוני שאיתו נרשמו לפלטפורמה.
