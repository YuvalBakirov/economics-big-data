...
analyze_correlation <- function(data, dataset_name) {
  ...
  corrplot(cor_matrix, method = "circle", title = paste("Correlation Matrix -", dataset_name), 
           mar = c(0, 0, 2, 0))  # Adding title with mar for top margin
}

# Call the function for train_filtered_1000m_data
analyze_correlation(train_filtered_1000m_data, "train_filtered_1000m_data")

# Call the function for train_filtered_2000m_data
analyze_correlation(train_filtered_2000m_data, "train_filtered_2000m_data")
