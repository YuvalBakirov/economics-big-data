...
* year - Probably because there is only one year in the data - 2014. We will remove it.
...
Note: We see that there are low correlations with the variables: hour, minute and dayInMonth with the label. For now we will keep it as is them but we may remove them later.
...
Note: We see that there are low correlations with the variables: minute and dayInMonth with the label. For now we will keep it as is them but we may remove them later.
